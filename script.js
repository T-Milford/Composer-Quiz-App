...
// this function will render HTML generated by questionHTMLGenerator by inserting it into .js-main_window
function questionDisplayer () {
    console.log('questionDisplayer ran');
    questionHTMLGenerator();

}

    // This function inserts the question and answers from questionBank into the neededHTML.  
    // Users will see which question they're on (for instance, "7 out of 10")
    // and their current score ("5 correct, 2 incorrect").
    function questionHTMLGenerator (){
        $('.js-main_window')
